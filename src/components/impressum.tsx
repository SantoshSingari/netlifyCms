...
// const ProffessionalTitle = styled(Title)`
//   width:500px;
//   margin-top:30px;
//   font-size:30px;
    ...
    return (
      <Layout>
        <BgContainer>
          ...
          <DescContainer>
            <Theory>tech.at.core has been working for us on multiple projects and most likely will do so again in the future because they stand out as a highly reliable, very versatile software engineers with an excellent and wide range of technical expertise and skillset.</Theory>
            <HqTiltle> HQ </HqTiltle>
            <AddressHq> tech.at.core
                            <Break></Break>
                            Seesener Str.43
                            <Break></Break>
                            10711 Berlin
